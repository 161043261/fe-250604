          ...
          >
            ...
            {Object.keys(callList).map((email) => {
              ...
              return (
                <div
                  key={email}
                  className={isFriend ? 'absolute inset-0 z-0' : 'relative m-1 h-[140px] w-[180px]'}
            ...
            {type === 'friend' && (
              <video
                className="video_self absolute top-2 right-2 z-10 h-[120px] w-[160px] rounded object-cover"
                autoPlay
                playsInline
                muted
              />
