      ...
      <div className="flex flex-col items-center justify-center py-8">
        ...
        <div className="mb-4 h-20 w-20 overflow-hidden rounded-full">
          {type === 'friend' ? (
            ...
            <div className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-teal-400 to-blue-400">
        ...
        {callState === 'calling' && (
          <>
            ...
            <p className="mb-6 text-lg font-medium text-blue-600">{formatCallTime(duration)}</p>
            <div className="flex gap-8">
              <button
                onClick={handleRejectCall}
                className="flex h-14 w-14 cursor-pointer items-center justify-center rounded-full bg-red-500 text-white shadow-lg transition hover:bg-red-600"
