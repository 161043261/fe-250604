export function fmtBytes(bytes: number, fractionDigits: number = 2): string {
  if (bytes === 0) {
    return "0B";
  }
...
export function camel2snake<T extends Record<string, unknown>>(obj: T): Record<string, unknown> {
...
export function snack2camel<T extends Record<string, unknown>>(obj: T): Record<string, unknown> {
